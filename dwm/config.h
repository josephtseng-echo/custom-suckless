...
static const char *fonts[]          = { "Sarasa Mono SC Nerd regular:size=10", "NotoColorEmoji:pixelsize=10:antialias=true:autohint=true" };
static const char dmenufont[]       = "Sarasa Mono SC Nerd regular:size=10";
...
static const char norm_fg[] = "#d8dee9"; //"#88C0D0";
static const char norm_bg[] = "#2E3440"; //"#2E3440";
static const char norm_border[] = "#3B4252"; //"#2e3440";

static const char bar_border[] = "#4C566A";

static const char sel_fg[] = "#D8DEE9"; //"#D08770";
static const char sel_bg[] = "#4c566a"; //"#4C566A";
static const char sel_border[] = "#88c0d0"; //"#8FBCBB";

static const char urg_fg[] = "#5E81AC";
static const char urg_bg[] = "#2E3440";
static const char urg_border[] = "#5E81AC";
...
static const char *colors[][4]      = {
	...
	*/
    [SchemeNorm]    = { norm_fg,  norm_bg,   norm_border, normmarkcolor },
    [SchemeSel]     = { sel_fg,   sel_bg,    sel_border, selmarkcolor },
...
static const Rule rules[] = {
	...
	//{ "terminator",  NULL,    NULL,       1 << 8,       0,           0,           -1 },	
...
#include "patch/nextprevtag.c"
#include "patch/tatami.c"
...
//static const char *slock[] = { "i3lock", "-i", "/home/josephzeng/Pictures/BingWallpaper/20220424-OHR.YosemiteNightSky_ZH-CN5864740024_1920x1080.jpg", NULL };
static const char *slock[] = { "i3lock-fancy", NULL };
static const char *roficmd[] = { "rofi", "-show", "drun", "-show-icons", NULL };
static const char *layoutmenu_cmd = "~/.config/dwm/layoutmenu.sh";
...
static Key keys[] = {
	...
	{ MODKEY|ControlMask,			XK_n,      view_adjacent,  { .i = +1 } },
	{ MODKEY|ControlMask,			XK_p,      view_adjacent,  { .i = -1 } },
	{ MODKEY,                       XK_semicolon,togglemark,   {0} }, //Mod + ;
	...
	*/
    ...
    { MODKEY,						XK_i,      setlayout,      {.v = &layouts[8]} }, /* tatami */
    { MODKEY|ShiftMask,				XK_i,      focusmaster,    {0} }, /* focusmaster */
	...
	{ MODKEY|ControlMask,           XK_v,	     spawn,		      {.v = mute} },
};
